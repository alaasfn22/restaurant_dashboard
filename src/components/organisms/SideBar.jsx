    ...
    <>
      ...
      <div
        className={` ${
          open
            ? "translate-x-0  "
            : "-translate-x-full hidden rtl:translate-x-full  "
        } fixed  top-0 bottom-0 ltr:left-0  rtl:right-0 transition-transform ease-linear duration-300 z-[999] lg:hidden  w-full`}
      >
