  ...
  return (
    <div className="w-full h-72  ">
      <div className="w-full h-full overflow-hidden rounded-2xl relative  ">
        ...
        />
        <div className="absolute top-10 ltr:left-0 rtl:right-0 z-5 px-4 md:px-10  text-white w-full md:w-3/5 flex flex-col gap-3">
          <h3 className="text-xl ">UP TO</h3>
